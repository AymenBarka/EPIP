...
| P03 implementation | COMPLETE / CLOSED / FROZEN | P03-F00, P03-F01, and P03-F02 closed |
...
| P04-F00 | BLOCKED PENDING P02-R02 IMPLEMENTATION | Profile/configuration foundation only |
